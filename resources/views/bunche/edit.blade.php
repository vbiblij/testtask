...
@section('panel')
    <div class="panel-heading container-fluid">
        <div class="form-group">
            ...
            <div class="centered-child col-md-9 col-sm-7 col-xs-6">Edit bunche: <b>{{$bunche->name}}</b></div>
    ...
    <div class="panel-body">
        {!! Form::model($bunche, ['route' => ['bunche.update', $bunche->id], 'method' => 'PUT']) !!}

        @include('bunche._form')
